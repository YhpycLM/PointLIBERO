...
def make_dataset_from_rlds(
        ...
        *,
        ...
        pointcloud_obs_keys: Dict[str, Optional[str]] = {},  # ADDED: New argument for point cloud keys
    ...
    Args:
        ... (existing args) ...
        pointcloud_obs_keys (Mapping[str, str|None]): Same as `image_obs_keys`, but for point clouds. Keys will be
            prefixed with "pointcloud_".
        ... (existing args) ...
    Returns:
        ...
        - observation:
            ...
            - pointcloud_{name1, name2, ...} # pointcloud observations
    ...
    def restructure(traj):
        ...
        for new, old in pointcloud_obs_keys.items():
            if old is None:
                # Padding for point clouds would be an empty tensor of the correct type and shape.
                # This logic assumes padding is not immediately needed. For real use, you might
                # need a more sophisticated padding strategy.
                pass  # Or implement padding if required.
            else:
                new_obs[f"pointcloud_{new}"] = old_obs[old]
